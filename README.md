...
Подробное описание параметров — в [docs/ОПИСАНИЕ_ПРОЕКТА.md](docs/ОПИСАНИЕ_ПРОЕКТА.md).
...
В каталоге [docs/](docs/) — полное описание проекта, архитектура, конфиг и улучшения относительно оригинала.
